...
class ModeloEntregar{


	/*=============================================
	REGISTRO DE PRODUCTO
	=============================================*/
	static public function mdlIngresarEntregar($tabla, $datos){
	...
	static public function mdlMostrarSolicitudesPorEntregarGerente($tabla, $item, $valor, $orden, $consejo){
	...
	static public function mdlMostrarSolicitudesEntregar($tabla, $item, $valor, $orden){
	...
	static public function mdlMostrarSolicitudesPorEntregarObispo($tabla, $item, $valor, $orden, $barrio){
	...
	static public function mdlMostrarSolicitudesPorEntregarEstaca($tabla, $item, $valor, $orden, $estaca){
	...
	static public function mdlEntregar($tabla, $datos){
