...
class TablaSolicitudesEnCaminoObispo{

 	/*=============================================
 	 MOSTRAR LA TABLA DE SOLICITUDES
  	=============================================*/ 

	public function mostrarTablaSolicitudesEnCaminoObispo(){
        ...
        $barrio = $_GET["barrio"];
  		...
  		$barrio = ControladorEntregar::ctrMostrarSolicitudesEntregarObispo($item, $valor, $orden, $barrio);	
		  ...
		  for($i = 0; $i < count($barrio); $i++){
			...
			$botones =  "<div class='btn-group'><button class='btn btn-info btnVisualizarSolicitudesencaminoobispo' idSolicitudes='".$barrio[$i]["id"]."' '><i class='fa fa-eye'></i></button></div>"; 
...
=============================================*/ 
$activarSolicitudesEnCaminoObispo = new TablaSolicitudesEnCaminoObispo();
$activarSolicitudesEnCaminoObispo -> mostrarTablaSolicitudesEnCaminoObispo();
