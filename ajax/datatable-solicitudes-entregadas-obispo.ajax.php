...
class TablaSolicitudesEntregadasObispo{

 	/*=============================================
 	 MOSTRAR LA TABLA DE SOLICITUDES
  	=============================================*/ 

	public function mostrarTablaSolicitudesEntregadasObispo(){
        ...
        $barrio = $_GET["barrio"];
  		...
  		$barrio = ControladorEntregados::ctrMostrarSolicitudesEntregadosObispo($item, $valor, $orden, $barrio);	
		  ...
		  for($i = 0; $i < count($barrio); $i++){
			...
			$botones =  "<div class='btn-group'><button class='btn btn-info btnVisualizarSolicitudesentregadasobispo' idSolicitudes='".$barrio[$i]["id"]."' '><i class='fa fa-eye'></i></button></div>"; 
...
=============================================*/ 
$activarSolicitudesEntregadasObispo = new TablaSolicitudesEntregadasObispo();
$activarSolicitudesEntregadasObispo -> mostrarTablaSolicitudesEntregadasObispo();
