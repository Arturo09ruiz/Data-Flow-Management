...
<input class="idconsejo" type="hidden" value="<?php echo $_SESSION['idbarrio']; ?>" id="idconsejo">
...
$solicitudes = ControladorDesaprobar::ctrMostrarSolicitudesDesaprobadasC($item, $valor, $orden, $consejo);
...
<input type="hidden" class="idpais"  value="<?php echo $solicitudes["idpais"]; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="dosis form-control" rows="3" readonly><?php echo $solicitudes["dosis"]; ?></textarea>
