...
$(".tablaSolicitudGerente tbody").on(
  "click",
  "button.btnVisualizarSolicitudesGerente",
  function () {
    var idSolicitudes = $(this).attr("idSolicitudes");

    window.location =
      "index.php?ruta=visualizar-solicitudes&idSolicitudes=" + idSolicitudes;
  }
);
...
$(".cambios_gerente").click(function () {
  ...
  if (boton == 1) {
	...
	var aprobacion_f = $(".boton_aprobacion_finanzas").val();
	var comentarios_f = $(".comentarios_finanzas").val();


    document.getElementById("aprobacion").value = aprobacion;
    document.getElementById("comentarios").value = comentarios;
	document.getElementById("aprobacion_fi").value = aprobacion_f;
    document.getElementById("comentarios_fi").value = comentarios_f;
    ...
    document.getElementById("aprobacion_f").value = aprobacion_f;
    document.getElementById("comentarios_f").value = comentarios_f;
...
$(".cambios_gerente_2").click(function () {
  ...
  if (boton == 1) {
    ...
    var aprobacion_f = $(".boton_aprobacion_finanzas_2").val();

	var comentarios_f = $(".comentarios_finanzas_2").val();
