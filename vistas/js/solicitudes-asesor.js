...
$.ajax({
	...
	url: "ajax/datatable-solicitudes-asesor.ajax.php",
...
$('.tablaSolicitudAsesor').DataTable( {
    "ajax": "ajax/datatable-solicitudes-asesor.ajax.php?consejo="+consejo,
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
...
$(".tablaSolicitudAsesor tbody").on("click", "button.btnVisualizarSolicitudesAsesor", function(){
...
$(".aprobacion_asesor_2").click(function(){

    var boton = $(".boton_aprobacion_asesor_2").val();

    if(boton == 1){

    $(this).removeClass("aprobacion_asesor_2 form-control btn btn-info");

    $(this).addClass("aprobacion_asesor_2 form-control btn btn-danger");

    $("#aprobacion_asesor_2").html('Desaprobado');
    $("#boton_aprobacion_asesor_2").val(2);

    }else if(boton == 0){
        $(this).removeClass("aprobacion_asesor_2 form-control btn btn-info");

        $(this).addClass("aprobacion_asesor_2 form-control btn btn-success");
    	$("#aprobacion_asesor_2").html('Aprobado');
		$("#boton_aprobacion_asesor_2").val(1);
    }else if(boton == 2){
    $(this).removeClass("aprobacion_asesor_2 form-control btn btn-danger");
...
$(".cambios_asesor_2").click(function(){

    var boton = $(".boton_aprobacion_asesor_2").val();

	if(boton == 1){
        var id = $(".id_solicitud_asesor").val();
        var aprobacion = $(".boton_aprobacion_asesor_2").val();
        var comentarios = $(".comentarios_asesor_2").val();
