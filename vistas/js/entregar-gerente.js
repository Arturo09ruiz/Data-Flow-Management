...
$(".tablaSolicitudPorEntregarGerente").DataTable({
  ajax:
    "ajax/datatable-solicitudes-por-entregar-gerente.ajax.php?consejo=" +
    consejo,
  deferRender: true,
  retrieve: true,
  processing: true,
...
$(".tablaSolicitudPorEntregarGerente tbody").on(
  "click",
  ...
  function () {
    ...
    window.location =
      "index.php?ruta=visualizar-solicitudes-entregar&idSolicitudes=" +
      idSolicitudes;
  }
);
        ...
        $.ajax({
          ...
          success: function (respuesta) {
            ...
            document.getElementById(
              "aprobacion_gerente"
            ).value = aprobacion_gerente;
            document.getElementById(
              "comentarios_gerente"
            ).value = comentarios_gerente;
            document.getElementById(
              "aprobacion_asesor"
            ).value = aprobacion_asesor;
            document.getElementById(
              "comentarios_asesor"
            ).value = comentarios_asesor;
            document.getElementById(
              "aprobacion_finanzas"
            ).value = aprobacion_finanzas;
            document.getElementById(
              "comentarios_finanzas"
            ).value = comentarios_finanzas;
