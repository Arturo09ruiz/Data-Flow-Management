...
if(isset($_FILES["nuevaPlan2"]["tmp_name"])){
 ...
 if($_FILES["nuevaPlan2"]["type"] == "image/png"){
    ...
    static public function ctrGuardarSolicitudGerente()
    {
        ...
        if (isset($_POST["nuevoCodigo"])) {
            ...
            $respuesta = ModeloSolicitudes::mdlIngresarSolicitudesGerente($tabla, $datos);
            if ($respuesta == "ok") {
    ...
    static public function ctrGuardarEstadoGerente()
    {
        ...
        if (isset($_POST["aprobacion"])) {
            ...
            $datos = array(
                "id" => $_POST["id"], 
                "aprobacion_gerente" => $_POST["aprobacion"],              
                "comentarios_gerente" => $_POST["comentarios"]
                

            );

            $respuesta = ModeloSolicitudes::mdlGuardarEstadoGerente($tabla, $datos);
            if ($respuesta == "ok") {
